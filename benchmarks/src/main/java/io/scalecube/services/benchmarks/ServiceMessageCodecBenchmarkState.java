...
public class ServiceMessageCodecBenchmarkState extends BenchmarksState<ServiceMessageCodecBenchmarkState> {
  ...
  private ByteBuf byteBufMessage;
  ...
  protected void beforeAll() {
    ...
    this.byteBufMessage = generateByteBuf(serviceMessage);
  }
  ...
  public ByteBuf byteBufMessage() {
    return byteBufMessage.slice();
  }
  ...
  private ByteBuf generateByteBuf(ServiceMessage msg) {
    try {
