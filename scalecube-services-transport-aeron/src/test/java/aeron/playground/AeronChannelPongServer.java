...
public class AeronChannelPongServer {
  ...
  public static AeronChannelStartedServer start() {
    MediaDriver driver = MediaDriverBuilder.create("target/aeron/media/1.9.1");
    
    AeronWrapper wrapper = new DefaultAeronWrapper(driver.aeronDirectoryName());
